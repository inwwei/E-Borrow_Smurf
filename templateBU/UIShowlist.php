      ...
      if(isset($_SESSION['userName'])){
         ...
         if($role == 'student'){
           ...
           $conn = mysqli_connect($serverName,$userName,$userPassword,$dbName);
            ...
            where  item.StudentRight = 'อนุญาต' 
            AND item.TypeID = type.ID 
           ...
           $conn = mysqli_connect($serverName,$userName,$userPassword,$dbName);
            mysqli_set_charset($conn, "utf8");
            $sql = "SELECT * FROM item , type , status 
            where item.TeacherRight = 'อนุญาต' 
            AND item.TypeID = type.ID 
            AND item.Statusref = Status.IDst 
                ...
                <tr>
                    ...
                    <td scope="row" class="zen tcenter" style="width: 100px;">
                        ...
                        <?php } elseif($row['Statusref'] == "3"){?>
                             ...
                             <a><button
                             name="lent" type="submit" class="btn btn-warning">ถูกยืม</button>
                         </a>
                         ...
                         <?php }
                            ...
                            <a><button
                                name="lent" type="submit" class="btn btn-danger">ไม่พร้อม</button>
                            </a>
