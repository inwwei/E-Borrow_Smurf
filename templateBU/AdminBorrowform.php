...
<?php
    ...
    $idus = $_GET['idus'];
    $sql2 = mysqli_query($conn, "SELECT * FROM  useraccount WHERE idus = '$idus'");
    $res1 = mysqli_query($conn, $sql2);
    $us= mysqli_fetch_array($res1);
...
<div class="container linecerv">
    <div>
        <div></div><br>
        <div>
            <form class="form-horizontal" method="POST" onSubmit="fncSubmit()"action='FuncAdminBorrow.php?ItemID=<?php echo $row['ItemID'] ?>&&IDs=<?php echo $row['IDs'] ?>&&userID=<?php echo $usID['idus'] ?>&&Statusref=<?php echo $_GET['Statusref']; ?> '>
