                ...
                <details style="font-size: 20px">
                    ...
                    <div class="row newfont">
                            <div class="col-12 tcenter">
                                <input type="submit" class="btn btn-success" name="processinput" style="width: 200px" value="ตรวจสอบความถูกต้องผู้ยืม">
                            </div>
                            <br>
