...
?>
    <div class="container"><br>
        <div class="row newfont">
            ...
            <a href='Add.php'><button name="add" type="submit" class="btn btn-success my-4" 
                    style="width: 120px;">เพิ่มรายการ</button></a>&nbsp;&nbsp;
            
                <a href='TypeItem.php'><button  type="submit" class="btn btn-success " 
                        style="width: 120px;">เพิ่มประเภทครุภัณฑ์</button></a>&nbsp;&nbsp;
                        
                <a href='Request.php'><button name="Show" type="submit" class="btn btn-success my-4" 
                    style="width: 120px;">รายการคำร้องอนุมัติ</button></a>&nbsp;&nbsp;
...
<div style="display: flex;justify-content: center;">
    <table class="table center tcenter newfont" style="width: 1400px">
        <tr style="background-color: #ff9999">
            ...
            <th scope="col" class="zen" style="width: 450px;">การจัดการ</th>
        </tr>
    </table>
</div>
<div style="display: flex;justify-content: center;">
        ...
        <table class="table center table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="row" class="zen" style="width: 650px;">
                        ...
                        <a href='editform.php?ItemID=<?php echo $row['ItemID'] ?>&&IDs=<?php echo $row['IDs'] ?> '><button
                                ...
                                <a href='AdminBorrowform.php?ItemID=<?php echo $row['ItemID'] ?>&&IDs=<?php echo $row['IDs'] ?> '><button
                        ...
                        <a href='FuncDelete.php?ItemID=<?php echo $row['ItemID'] ?> '
                            onclick="return confirm('คุณต้องการลบครุภัณฑ์นี้ใช่หรือไม่!!!')"><button name="delete"
                                type="submit" class="btn btn-danger" style="width: 70px">ลบ</button>
